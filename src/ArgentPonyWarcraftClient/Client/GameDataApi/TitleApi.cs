...
namespace ArgentPonyWarcraftClient
{
    public partial class WarcraftClient
    {
        ...
        public async Task<RequestResult<TitlesIndex>> GetTitlesIndexAsync(string @namespace, Region region, Locale locale)
        {
            ...
            return await Get<TitlesIndex>(region, $"{host}/data/wow/title/index?namespace={@namespace}&locale={locale}");
        }
        ...
        {
            string host = GetHost(region);
            return await Get<Title>(region, $"{host}/data/wow/title/{titleId}?namespace={@namespace}&locale={locale}");
        }
    }
}
