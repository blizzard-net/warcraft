...
namespace ArgentPonyWarcraftClient
{
    public partial class WarcraftClient
    {
        ...
        public async Task<RequestResult<MountsIndex>> GetMountsIndexAsync(string @namespace, Region region, Locale locale)
        {
            ...
            return await Get<MountsIndex>(region, $"{host}/data/wow/mount/index?namespace={@namespace}&locale={locale}");
        }
        ...
        {
            string host = GetHost(region);
            return await Get<Mount>(region, $"{host}/data/wow/mount/{mountId}?namespace={@namespace}&locale={locale}");
        }
    }
}
