...
namespace ArgentPonyWarcraftClient
{
    public partial class WarcraftClient
    {
        ...
        public async Task<RequestResult<RegionsIndex>> GetRegionsIndexAsync(string @namespace, Region region, Locale locale)
        {
            ...
            return await Get<RegionsIndex>(region, $"{host}/data/wow/region/index?namespace={@namespace}&locale={locale}");
        }
        ...
        {
            string host = GetHost(region);
            return await Get<RegionData>(region, $"{host}/data/wow/region/{regionId}?namespace={@namespace}&locale={locale}");
        }
    }
}
